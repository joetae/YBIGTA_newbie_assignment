...
processed_train = transforms.Compose([
...
processed_test = transforms.Compose([
    transforms.ToTensor(),  
    transforms.Normalize((0.5, 0.5, 0.5), (0.5, 0.5, 0.5)),
])

# CIFAR-10 데이터셋 로드
train_dataset = datasets.CIFAR10(root="./data", train=True, download=True, transform=processed_train)
train_loader = DataLoader(train_dataset, batch_size=BATCH_SIZE, shuffle=True)

test_dataset = datasets.CIFAR10(root="./data", train=False, download=True, transform=processed_test)
...
# resnet 18 선언하기
## TODO
model = ResNet(BasicBlock, num_blocks=[2, 2, 2, 2], num_classes=10).to(device)
